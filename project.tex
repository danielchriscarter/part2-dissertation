...
The project includes a demonstration web application as well a patches to PostgreSQL and Apache's \verb+mod_auth_gssapi+ module, and there was some interest from the PostgreSQL developer community in including the patch in a future release.
